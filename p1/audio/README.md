...
**Ограничения:** внутри контейнера волна приводится к **16 kHz** mono float, как ожидает YAMNet. Для class map при первом запуске требуется **исходящая сеть** (скачивание CSV с GitHub).
